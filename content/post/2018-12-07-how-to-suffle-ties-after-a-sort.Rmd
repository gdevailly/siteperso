...
it is frequent to have ties for certain value (for example, 0 expression values).
...
This can lead to ungracefull artefacts in some plots. 
...
Here, many exons have $\psi = 1$, and there order default to a genomic coordinate ordering.
We can see some darker horizontal stripes, that may reflect contigous chromatin domains,
...
Actually, never mind, the grouping is totaly unecessary,
